...
func (s *Drinks) ListDrinks(ctx context.Context, security operations.ListDrinksSecurity, drinkType *shared.DrinkType, opts ...operations.Option) (*operations.ListDrinksResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
